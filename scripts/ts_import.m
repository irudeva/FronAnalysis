...
for issn = 1:5
 frN(isec,issn,:) = cell2mat(raw(:,issn));
end
...
%% Allocate imported array to column variable names
for issn = 1:5
 STRint(isec,issn,:) = cell2mat(raw(:,issn));
end
...
%% Allocate imported array to column variable names
for issn = 1:5
 STRloc(isec,issn,:) = cell2mat(raw(:,issn));
end
...
%% Allocate imported array to column variable names
for issn = 1:5
 mslp40(isec,issn,:) = cell2mat(raw(:,issn));
end
...
%% Allocate imported array to column variable names
for issn = 1:5
 mslp65(isec,issn,:) = cell2mat(raw(:,issn));
end
...
%% Allocate imported array to column variable names
for issn = 1:5
 SAMssn(isec,issn,:) = cell2mat(raw(:,issn));
end
